    ...
    return (
        <div className="flex flex-row ">
            <div className='w-6/10 ml-15 mt-10'>
                ...
                <hr className="mt-5 mb-3 h-px bg-gray-300 border-0 "></hr>
                <div className='text-lg font-semibold mb-5'>Latest Schedule</div>
                <div className='flex gap-10 '>
                    <p className='font-medium w-25'>Monday</p>
                    <div>
                        <p>09:00 - 10:00</p>
                        <p>14:00 - 15:00</p>
                        <p>16:00 - 17:00</p>
                ...
                <div className='flex gap-10 mt-3'>
                    <p className='font-medium w-25'>Tuesday</p>
                    <div>
                        <p>09:00 - 10:00</p>
                        <p>14:00 - 15:00</p>
                        <p>16:00 - 17:00</p>
                ...
                <div className='flex gap-10  mt-3'>
                    <p className='font-medium w-25'>Wednesday</p>
                    <div>
                        <p>09:00 - 10:00</p>
                        <p>14:00 - 15:00</p>
                        <p>16:00 - 17:00</p>
                ...
                <div className='flex gap-10  mt-3'>
                    <p className='font-medium w-25'>Thursday</p>
                    <div>
                        <p>09:00 - 10:00</p>
                        <p>14:00 - 15:00</p>
                        <p>16:00 - 17:00</p>
                ...
                <div className='flex gap-10 mt-3'>
                    <p className='font-medium w-25'>Friday</p>
                    <div>
                        <p>09:00 - 10:00</p>
                        <p>14:00 - 15:00</p>
                        <p>16:00 - 17:00</p>
                    ...
                    <div key={appointment.id} className="w-100  p-5 bg-white border border-gray-100 rounded-[5px] shadow-sm hover:bg-gray-50">
                        ...
                        <div className="mt-2">
                            ...
                            <div className="relative inline-block text-left w-full  ">
                                <div>
                                    <button type="button" className="inline-flex w-full justify-between rounded-xs bg-white px-3 py-3 my-4 text-md font-medium  text-gray-900 ring-1 shadow-xs ring-gray-300  items-center" id="menu-button" aria-expanded={isTimeOpen} aria-haspopup="true"
                                    onClick={toggleTime}>
                                        Time
                                        <svg
                                            data-accordion-icon
